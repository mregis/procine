...
CREATE TABLE processo (processo_id INT UNSIGNED AUTO_INCREMENT, processo_nm_descricao VARCHAR(60) NOT NULL, processo_nm_rota VARCHAR(40) DEFAULT ' ' NOT NULL, processo_nu_status TINYINT UNSIGNED DEFAULT '1' NOT NULL, INDEX menu_id_idx (menu_id), PRIMARY KEY(processo_id)) ENGINE = INNODB;
CREATE TABLE usuario (usuario_id INT UNSIGNED AUTO_INCREMENT, usuario_nm_nomeacesso VARCHAR(128) NOT NULL, usuario_nm_nome VARCHAR(255) NOT NULL, usuario_nm_email VARCHAR(255) NOT NULL, usuario_nu_cpf CHAR(11) DEFAULT '0' NOT NULL, usuario_dt_dtnascimento DATE, usuario_nm_algoritmo VARCHAR(128), usuario_nm_salt VARCHAR(128), usuario_nm_senha VARCHAR(128) NOT NULL, usuario_nu_status TINYINT UNSIGNED DEFAULT '1' NOT NULL, usuario_ts_ultimoacesso DATETIME DEFAULT '0000-00-00 00:00:00' NOT NULL, PRIMARY KEY(usuario_id)) ENGINE = INNODB;
...
ALTER TABLE processo ADD CONSTRAINT processo_menu_id_menu_menu_id FOREIGN KEY (menu_id) REFERENCES menu(menu_id);
